...
-keep public interface library.utils.security.securedata.SecureData$* {*;}
-keep interface library.utils.security.securedata.SecureData$* {*;}
-keep class library.utils.security.securedata.SecureData$* {*;}
