...
public class NavigationManager {
     ...
     * <p/>
     * If the Fragment needs to be replaced, will NavigationManager will substitue the current Fragment
     ...
     * <ul>
     * <li>Considering if the necessity of {@link NavigationFragment#isSingleInstance() adding another instance of such fragment class}</li>
     * <li>{@link #processClearBackstack(int) Processing clearing backstack flags conditions}</li>
     * <li>{@link #processAddToBackstackFlag(String, int, android.support.v4.app.FragmentTransaction) Process adding to backstack flags conditions}</li>
     * <li>{@link #processAnimations(FragmentAnimation, android.support.v4.app.FragmentTransaction) Process the state of the deserved animations if any}</li>
     * <li>{@link #performTransaction(android.support.v4.app.Fragment, int, android.support.v4.app.FragmentTransaction, int) Perform the actual transaction}</li>
     * </ul>
     * <p/>
     * If the fragment is not required to be readded (as in a up navigation) the fragment manager
     * will pop all the backstack until the desired fragment and the {@link NavigationFragment#onFragmentVisible() onFragmentVisible()}
     ...
     * If so, the Navigation Manager will execute its {@link NavigationFragment#onBackPressed() onBackPressed()} method.
     * <p/>
     ...
     * <p/>
     * Otherwise will pop the inmediate Fragment and execute its {@link NavigationFragment#onFragmentVisible()}
     *
     * @param containerId Target container ID
     */
     ...
     * NavigationManager because I did not want to enforce any termination conditions itself. However
